...
import { getAllBlogPosts, addBlogPost, removeBlogPost } from "../services/blogPostsServices"
...
const App = () => {
	...
	function deleteBlogPost(id, props) {
			...
			<div className="container">				
				<BrowserRouter>
					...
					<Switch>
						...
						<Route exact path="/posts/:id" render ={ (props) => <BlogPosts {...props} blogPosts={blogPosts} loggedInUser={loggedInUser} deleteBlogPost={deleteBlogPost}/> } />
						<Route exact path="/posts" render ={ (props) => <BlogPosts {...props} blogPosts={blogPosts} loggedInUser={loggedInUser} deleteBlogPost={deleteBlogPost} /> } />
